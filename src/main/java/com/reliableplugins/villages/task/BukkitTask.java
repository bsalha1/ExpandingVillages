...
public abstract class BukkitTask implements Runnable
{
    ...
    {
        this.id = Bukkit.getScheduler().scheduleSyncDelayedTask(Main.INSTANCE, this, delay);
        delayed = delay > 0;
        repeating = false;
    }
    ...
    {
        this.id = Bukkit.getScheduler().scheduleSyncRepeatingTask(Main.INSTANCE, this, delay, period);
        delayed = delay > 0;
        repeating = true;
    }
